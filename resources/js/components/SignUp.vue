        ...
        <div class="mx-auto w-full">
            <div class="mb-12 -mt-12 px-3">
                <div class="w-full md:w-3/3 flex align">
                    ...
                    <a href="/login" class="block mt-4 text-sm lg:inline-block lg:mt-0 text-indigo-800 hover:text-indigo-500 mr-4">
						Sign in
					</a>
                </div>
            </div>
            <div class="px-3 mb-12 -mt-8 text-center">
                <div class="w-full md:w-3/3">
                    <span
                        class="font-light text-xl flex-1 text-indigo-900"
                        >Create a workspace for your team, and start assigning tasks today.</span>
                </div>
            </div>
                            ...
                            >
                                ...
                                <div class="flex items-center">
                                    <div class="text-gray-700 mr-auto tracking-tighter">
                                        <span class="font-semibold text-2xl"> € {{ (plan.amount * plan.members_limit) / 100 }}</span> <span class="text-xl font-light"> / month </span>  
                                    </div>
                                    <div class="text-gray-700 text-left w-1/3">
                                       <span class="text-sm font-light">{{ plan.members_limit }} member slots. Unlimited storage, and more...</span>  
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class=" -mx-3 mb-1">
                                    <div class="w-full md:w-3/3 px-3">
                                        ...
                                        <p
                                            ...
                                            v-text="form.errors.get('email_confirmation')"
                                        ></p>
                                    </div>
                                </div>
                                <div class=" -mx-3 mb-1">
