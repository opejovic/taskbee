<template>
	<div class="dropdown">
		<span class="dropdown__header" @click="toggleDropdown($event)">
			<span class="block mt-4 lg:inline-block lg:mt-0 text-indigo-800 hover:text-indigo-500 mr-4">Browse</span>
			<i class="fa fa-angle-down" aria-hidden="true"></i>
			<i class="fa fa-angle-up" aria-hidden="true"></i>
		</span>

		<div class="dropdown__content bg-gray-200 rounded border fixed">
			<ul>
				<li><a
				:href="allTasks"
