  ...
  >
    ...
    <div class="mx-auto w-full">
      ...
      <div class="pt-5 pb-5 text-center">
        <div class="w-full py-8 curve-pattern rounded-lg">
          <span class="font-light text-2xl flex-1 text-indigo-900"
