...
class SubscriptionTest extends TestCase
{
    ...
    /** @test */
    public function can_be_built_from_stripes_subscription_and_an_email()
    {
    ...
    /** @test */
    public function it_can_tell_if_its_expired()
    {
    ...
    /** @test */
    public function it_can_tell_if_its_canceled()
    {
