...
class UserTest extends TestCase
{
    ...
    /** @test */
    public function can_own_a_workspace()
    {
    ...
    /** @test */
    public function can_own_many_workspaces()
    {
        $user = factory(User::class)->create(['role' => User::ADMIN]);
    ...
    /** @test */
    public function can_create_many_tasks()
    {
        $user = factory(User::class)->states('member')->create();
    ...
    /** @test */
    public function can_belong_to_a_workspace()
    {
    ...
    /** @test */
    public function can_belong_to_many_workspaces()
    {
