...
class StripeSubscriptionGatewayTest extends TestCase
{
    ...
    /** @test */
    public function customer_is_created_if_a_valid_payment_token_is_provided()
    {
    ...
    /** @test */
    public function customer_is_not_created_if_a_invalid_payment_token_is_provided()
    {
    ...
    /** @test */
    public function cannot_create_two_customers_with_the_same_email()
    {
    ...
    /** @test */
    public function subscription_to_a_bundle_can_be_created_for_a_customer()
    {
        $customer = $this->subGateway->createCustomer('john@example.com', $this->validToken());
